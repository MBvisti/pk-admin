...
export const SideBar = () => {
    ...
    return (
        <div className="md:w-80 md:flex md:flex-col md:max-h-screen md:bg-gray-600 md:overflow-y-hidden">
            ...
            <div className="md:mt-12 md:pl-10 md:relative md:overflow-y-scroll">
                ...
                <SideBarElement
                    handleActiveElement={(e: Event) => handleActiveElement(e)}
                    icon={<MdPlace className="md:mr-4 md:h-6 md:w-6 md:stroke-current md:text-white" />}
                ...
                <SideBarElement
                    handleActiveElement={(e: Event) => handleActiveElement(e)}
                    icon={<BiEuro className="md:mr-4 md:h-6 md:w-6 md:stroke-current md:text-white" />}
                ...
                <SideBarElement
                    handleActiveElement={(e: Event) => handleActiveElement(e)}
                    icon={<FaUsers className="md:mr-4 md:h-6 md:w-6 md:stroke-current md:text-white" />}
                ...
                <SideBarElement
                    handleActiveElement={(e: Event) => handleActiveElement(e)}
                    icon={<RiParkingLine className="md:mr-4 md:h-6 md:w-6 md:stroke-current md:text-white" />}
                ...
                <SideBarElement
                    handleActiveElement={(e: Event) => handleActiveElement(e)}
                    icon={<BsExclamationTriangle className="md:mr-4 md:h-6 md:w-6 md:stroke-current md:text-white" />}
                    subLinks={["Parking tickets", "Vehicle violation", "Property violation"]}
                ...
                <SideBarElement
                    handleActiveElement={(e: Event) => handleActiveElement(e)}
                    icon={<IoHardwareChipOutline className="md:mr-4 md:h-6 md:w-6 md:stroke-current md:text-white" />}
                    subLinks={["Live view"]}
                ...
                <SideBarElement
                    handleActiveElement={(e: Event) => handleActiveElement(e)}
                    icon={<FiMessageSquare className="md:mr-4 md:h-6 md:w-6 md:stroke-current md:text-white" />}
                ...
                <SideBarElement
                    handleActiveElement={(e: Event) => handleActiveElement(e)}
                    icon={<FaWpforms className="md:mr-4 md:h-6 md:w-6 md:stroke-current md:text-white" />}
                ...
                <SideBarElement
                    handleActiveElement={(e: Event) => handleActiveElement(e)}
                    icon={<FiSettings className="md:mr-4 md:h-6 md:w-6 md:stroke-current md:text-white" />}
